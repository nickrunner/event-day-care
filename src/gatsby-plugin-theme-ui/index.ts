...
const theme = merge(tailwind, {
  ...
  colors: {
    primary: pallete.primary.light,
    secondary: pallete.secondary.light,
    text: pallete.primary.light,
    heading: pallete.primary.light,
    background: pallete.primary.dark,
    ...
    modes: {
      light: {
        text: pallete.primary.dark,
        heading: pallete.primary.dark,
        primary: pallete.primary.dark,
